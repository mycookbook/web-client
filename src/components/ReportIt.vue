		...
		<div class="ui modal">
			...
			<div class="scrolling content">
				...
				<div>
					...
					<label for="violation">It violates community guidelines. (see community guidelines <a
							href="https://web.cookbookshq.com/#/usage-policy">here</a>)</label><br /><br />
				...
				<div>
					<div class="ui label">
						Our conflict resolution/hygiene team will reach out to you if need be, within 10-28 business
						days.
					</div>
				</div>
				<hr />
