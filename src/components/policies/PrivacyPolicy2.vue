...
<div>
    ...
    <div class="policyHeader" :style="{ backgroundImage: 'url(' + image + ')' }">
        <h1 class="dataHeader1">Privacy Policy</h1>
    </div>
    <div class="ui container" style="margin-top:10vh;">
        <div class="ui grid">
            <div class="sixteen wide column">
                <div>
                    <p>
                        At CookbooksHQ, accessible from <a
                            href="https://web.cookbookshq.com">https://web.cookbookshq.com</a>, one of our main
                        priorities is the privacy of our visitors. This Privacy Policy document contains types of
                        information that is collected
                        and recorded by CookbooksHQ and how we use it.
                    </p>
                    ...
                    <p>
                        ...
                        website with regards to the information that they shared and/or collect in CookbooksHQ. This
                        policy is not
                    ...
                    <h4 class="dataHeader4">Consent</h4>
                    <p>
                        By using our website, you hereby consent to our Privacy Policy and agree to its terms.
                    </p>
                    <h4 class="dataHeader4">
                    ...
                    <h3 class="dataHeader3">How we use your information</h3>
                    <p>
                    ...
                    <h3 class="dataHeader3">
                        Log Files
                    </h3>
                    <p>
                        CookbooksHQ follows a standard procedure of using log files. These files log visitors when they
                    ...
                    <p>
                        ...
                        that are used in their respective advertisements and links that appear on CookbooksHQ, which are
                    ...
                    <p>
                        Note that CookbooksHQ has no access to or control over these cookies that are used by
                    ...
                    <p>
                        CookbooksHQ's Privacy Policy does not apply to other advertisers or websites. Thus, we are
                    ...
                    <p>
                        CookbooksHQ does not knowingly collect any Personal Identifiable Information from children under
...
import policyImage from '../../assets/img/privacy.jpg';
